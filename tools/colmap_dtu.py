...
def pipeline(scene, base_path, n_views):
    ...
    res = os.popen( 'colmap feature_extractor --database_path database.db --image_path images  --SiftExtraction.max_image_size 4032 --SiftExtraction.max_num_features 32768').read()
    ...
    print(f"exhaustive_matcher done")
...
for scene in ['scan8', 'scan21', 'scan30', 'scan31', 'scan34', 'scan38', 'scan40', 'scan41', 'scan45', 'scan55', 'scan63', 'scan82', 'scan103', 'scan110', 'scan114']:
    pipeline(scene, base_path=base_path, n_views=6)
for scene in ['scan8', 'scan21', 'scan30', 'scan31', 'scan34', 'scan38', 'scan40', 'scan41', 'scan45', 'scan55', 'scan63', 'scan82', 'scan103', 'scan110', 'scan114']:
    pipeline(scene, base_path=base_path, n_views=9)
