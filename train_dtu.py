...
from utils.general_utils import safe_state, get_expon_noise_ration_func
from utils.pose_utils import generate_pseudo_views
...
def training_scene(dataset, opt, pipe, args):
    ...
    saving_iterations, checkpoint_iterations, checkpoint, debug_from = args.save_iterations, args.checkpoint_iterations, args.start_checkpoint, args.debug_from
...
if __name__ == "__main__":
    ...
    parser.add_argument('--noise_ratio_max', type=float, default=0.08)
    parser.add_argument('--noise_ratio_min', type=float, default=0.02)
